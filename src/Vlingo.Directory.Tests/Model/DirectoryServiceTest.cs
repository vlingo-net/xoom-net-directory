...
namespace Vlingo.Directory.Tests.Model
{
    public class DirectoryServiceTest : IDisposable
    {
        ...
        public void TestAlteredLeadership()
        {
            ...
            Assert.Equal(3, accessSafely1.ReadFromExpecting("interestedIn", 3, 10_000));
            Assert.Equal(3, accessSafely2.ReadFromExpecting("interestedIn", 3, 10_000));
            Assert.Equal(3, accessSafely3.ReadFromExpecting("interestedIn", 3, 10_000));
            
            Assert.Equal(3, accessSafely1.ReadFromExpecting("informDiscovered", 3, 10_000));
            Assert.Equal(3, accessSafely2.ReadFromExpecting("informDiscovered", 3, 10_000));
            Assert.Equal(3, accessSafely3.ReadFromExpecting("informDiscovered", 3, 10_000));
